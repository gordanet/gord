...
type configFlags struct {
	...
	AllowConnectionToDifferentVersions bool   `short:"a" long:"allow-connection-to-different-versions" description:"Allow connections to versions different than gorctl's version'"`
...
func parseConfig() (*configFlags, error) {
	...
	parser.Usage = "gorctl [OPTIONS] [COMMAND] [COMMAND PARAMETERS].\n\nCommand can be supplied only if --json is not used." +
		"\n\nUse `gorctl --list-commands` to get a list of all commands and their parameters." +
