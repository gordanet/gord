...
func generateTxs() (nativeTx, subnetworkTx *externalapi.DomainTransaction, err error) {
	...
	address1Str := "gorsim:qzpj2cfa9m40w9m2cmr8pvfuqpp32mzzwsuw6ukhfduqpp32mzzws59e8fapc"
	address1, err := util.DecodeAddress(address1Str, util.Bech32PrefixGorSim)
	if err != nil {
	...
	address2Str := "gorsim:qr7w7nqsdnc3zddm6u8s9fex4ysk95hm3v30q353ymuqpp32mzzws59e8fapc"
	address2, err := util.DecodeAddress(address2Str, util.Bech32PrefixGorSim)
	if err != nil {
...
func getSourceScript(b *testing.B) *externalapi.ScriptPublicKey {
	sourceAddressStr := "gorsim:qz6f9z6l3x4v3lf9mgf0t934th4nx5kgzu663x9yjh"

	sourceAddress, err := util.DecodeAddress(sourceAddressStr, util.Bech32PrefixGorSim)
	if err != nil {
