/*
Package txscript implements the gor transaction script language.

This package provides data structures and functions to parse and execute
gor transaction scripts.

# Script Overview

Gor transaction scripts are written in a stack-base, FORTH-like language.

The gor script language consists of a number of opcodes which fall into
...
Typical gor scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend gor.
