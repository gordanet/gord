...
// SignatureScript creates an input signature script for tx to spend GOR sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend GOR sent
