...
import (
	...
	"github.com/gordanet/gord/domain/consensus/utils/virtual"
...
// This is a sanity test, to make sure that gord doesn't store, and subsequently sends syncing peers the wrong UTXOSet.
