...
// Params defines a Gor network by its parameters. These parameters may be
// used by Gor applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// PruningProofM is the 'm' constant in the pruning proof. For more details see: https://github.com/gordanet/research/issues/3
...
// MainnetParams defines the network parameters for the main Gor network.
...
// TestnetParams defines the network parameters for the test Gor network.
...
// SimnetParams defines the network parameters for the simulation test Gor
...
// DevnetParams defines the network parameters for the development Gor network.
...
// ErrDuplicateNet describes an error where the parameters for a Gor
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Gor network")

var registeredNets = make(map[appmessage.GorNet]struct{})

// Register registers the network parameters for a Gor network. This may
