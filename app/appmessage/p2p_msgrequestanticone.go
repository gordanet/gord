...
// MsgRequestAnticone implements the Message interface and represents a gor
...
// NewMsgRequestAnticone returns a new gor RequestPastDiff message that conforms to the
