...
// MsgRequestAnticone implements the Message interface and represents a gord
...
// NewMsgRequestAnticone returns a new gord RequestPastDiff message that conforms to the
