...
// MsgRequestTransactions implements the Message interface and represents a gord
...
// NewMsgRequestTransactions returns a new gord RequestTransactions message that conforms to
