...
// MsgRequestTransactions implements the Message interface and represents a gor
...
// NewMsgRequestTransactions returns a new gor RequestTransactions message that conforms to
