...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a gor
...
// NewMsgDoneBlocksWithTrustedData returns a new gor DoneBlocksWithTrustedData message that conforms to the
// Message interface.
