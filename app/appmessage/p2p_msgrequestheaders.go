...
// MsgRequestHeaders implements the Message interface and represents a gor
...
// NewMsgRequstHeaders returns a new gor RequestHeaders message that conforms to the
