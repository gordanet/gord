...
// MsgRequestHeaders implements the Message interface and represents a gord
...
// NewMsgRequstHeaders returns a new gord RequestHeaders message that conforms to the
