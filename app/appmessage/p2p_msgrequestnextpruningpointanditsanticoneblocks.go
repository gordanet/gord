...
// MsgRequestNextPruningPointAndItsAnticoneBlocks implements the Message interface and represents a gord
...
// NewMsgRequestNextPruningPointAndItsAnticoneBlocks returns a new gord RequestNextPruningPointAndItsAnticoneBlocks message that conforms to the
// Message interface.
