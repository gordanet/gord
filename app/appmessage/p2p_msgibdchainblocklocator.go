...
// MsgIBDChainBlockLocator implements the Message interface and represents a gor
...
// NewMsgIBDChainBlockLocator returns a new gor locator message that conforms to
