...
// MsgRequestAddresses implements the Message interface and represents a gor
...
// NewMsgRequestAddresses returns a new gor RequestAddresses message that conforms to the
