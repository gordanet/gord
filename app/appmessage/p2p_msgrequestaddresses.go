...
// MsgRequestAddresses implements the Message interface and represents a gord
...
// NewMsgRequestAddresses returns a new gord RequestAddresses message that conforms to the
