...
// MsgRequestRelayBlocks implements the Message interface and represents a gord
...
// NewMsgRequestRelayBlocks returns a new gord RequestRelayBlocks message that conforms to
