...
// MsgRequestNextHeaders implements the Message interface and represents a gor
...
// NewMsgRequestNextHeaders returns a new gor RequestNextHeaders message that conforms to the
// Message interface.
