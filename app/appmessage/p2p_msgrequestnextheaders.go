...
// MsgRequestNextHeaders implements the Message interface and represents a gord
...
// NewMsgRequestNextHeaders returns a new gord RequestNextHeaders message that conforms to the
// Message interface.
