...
// MsgTransactionNotFound defines a gord TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new gord transactionsnotfound message that conforms to the
