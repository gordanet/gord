...
// MsgTransactionNotFound defines a gor TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new gor transactionsnotfound message that conforms to the
