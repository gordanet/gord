...
var DefaultUserAgent = fmt.Sprintf("/gord:%s/", version.Version())

// MsgVersion implements the Message interface and represents a gor version
...
// NewMsgVersion returns a new gor version message that conforms to the
