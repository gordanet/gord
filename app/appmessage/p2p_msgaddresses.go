...
// gor Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a gor
// Addresses message.
...
// NewMsgAddresses returns a new gor Addresses message that conforms to the
