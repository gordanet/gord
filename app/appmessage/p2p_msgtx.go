...
// Outpoint defines a gord data type that is used to track previous
// transaction outputs.
...
// NewOutpoint returns a new gord transaction outpoint point with the
...
// TxIn defines a gord transaction input.
type TxIn struct {
...
// NewTxIn returns a new gord transaction input with the provided
...
// TxOut defines a gord transaction output.
type TxOut struct {
	Value        uint64
...
// MsgTx implements the Message interface and represents a gord tx message.
