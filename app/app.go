...
import (
	...
	"github.com/gordanet/gord/infrastructure/os/execenv"
	"github.com/gordanet/gord/infrastructure/os/limits"
	"github.com/gordanet/gord/infrastructure/os/signal"
	"github.com/gordanet/gord/infrastructure/os/winservice"
...
var serviceDescription = &winservice.ServiceDescription{
	...
	Description: "Downloads and stays synchronized with the Gor blockDAG and " +
...
// StartApp starts the gord app, and blocks until it finishes running
func StartApp() error {
...
func (app *gordApp) main(startedChan chan<- struct{}) error {
