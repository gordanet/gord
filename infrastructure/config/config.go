...
// Flags defines the configuration options for gord.
//
...
type Flags struct {
	...
	MinRelayTxFee                   float64       `long:"minrelaytxfee" description:"The minimum transaction fee in GOR/kB to be considered a non-zero fee."`
...
// DefaultConfig returns the default gord configuration
...
//
// The above results in gord functioning properly without any config settings
...
// createDefaultConfig copies the file sample-gord.conf to the given destination path,
