...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/gordanet/gord/database)

Package database provides a database for gord.
...
DataAccessor
------------
This defines the common interface by which data gets accessed in a generic gord
...
Transaction
-----------
This defines the interface of a generic gord database transaction.
