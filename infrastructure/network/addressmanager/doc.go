/*
Package addressmanager implements concurrency safe Gor address manager.

# Address Manager Overview

In order maintain the peer-to-peer Gor network, there needs to be a source
of addresses to connect to as nodes come and go. The Gor protocol provides
