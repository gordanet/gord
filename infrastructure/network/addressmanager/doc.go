/*
Package addressmanager implements concurrency safe Gord address manager.

# Address Manager Overview

In order maintain the peer-to-peer Gord network, there needs to be a source
of addresses to connect to as nodes come and go. The Gord protocol provides
