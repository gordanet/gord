...
import (
	...
	"github.com/gordanet/gord/infrastructure/network/netadapter/server"
...
type grpcStream interface {
	Send(*protowire.GordMessage) error
	Recv() (*protowire.GordMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.GordMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.GordMessage) error {
