...
func (x *GordMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "GordMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *GordMessage_RequestPruningPointUTXOSet) fromAppMessage(
