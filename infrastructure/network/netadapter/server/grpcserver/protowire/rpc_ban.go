...
func (x *GordMessage_BanRequest) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "GordMessage_BanRequest is nil")
	}
...
func (x *GordMessage_BanRequest) fromAppMessage(message *appmessage.BanRequestMessage) error {
...
func (x *GordMessage_BanResponse) fromAppMessage(message *appmessage.BanResponseMessage) error {
	var err *RPCError
