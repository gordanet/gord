...
func (x *GordMessage_RequestAddresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "GordMessage_RequestAddresses is nil")
	}
...
func (x *RequestAddressesMessage) toAppMessage() (appmessage.Message, error) {
	...
	//  Full gor nodes set SubnetworkId==nil
...
func (x *GordMessage_RequestAddresses) fromAppMessage(msgGetAddresses *appmessage.MsgRequestAddresses) error {
