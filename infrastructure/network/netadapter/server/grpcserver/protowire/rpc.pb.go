...
type GetBlockTemplateRequestMessage struct {
	...
	// Which gor address should the coinbase block reward transaction pay into
...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether gord thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when gord is not synced.
	// That is because when gord isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this gord initiated the connection
	...
	// The timestamp of when this peer connected to this gord
