...
func (x *GordMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "GordMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *GordMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
