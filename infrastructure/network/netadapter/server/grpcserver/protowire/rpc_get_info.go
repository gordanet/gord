...
func (x *GordMessage_GetInfoRequest) toAppMessage() (appmessage.Message, error) {
	return &appmessage.GetInfoRequestMessage{}, nil
}

func (x *GordMessage_GetInfoRequest) fromAppMessage(_ *appmessage.GetInfoRequestMessage) error {
...
func (x *GordMessage_GetInfoResponse) fromAppMessage(message *appmessage.GetInfoResponseMessage) error {
	var err *RPCError
