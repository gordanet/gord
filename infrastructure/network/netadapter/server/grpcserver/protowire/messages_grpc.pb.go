...
type P2P_MessageStreamClient interface {
	Send(*GordMessage) error
	Recv() (*GordMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *GordMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*GordMessage, error) {
	m := new(GordMessage)
...
func (x *p2PMessageStreamServer) Send(m *GordMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*GordMessage, error) {
	m := new(GordMessage)
...
func (x *rPCMessageStreamClient) Send(m *GordMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*GordMessage, error) {
	m := new(GordMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *GordMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*GordMessage, error) {
	m := new(GordMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
