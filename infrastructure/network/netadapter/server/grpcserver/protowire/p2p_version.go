...
func (x *GordMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "GordMessage_Version is nil")
	}
...
func (x *GordMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
