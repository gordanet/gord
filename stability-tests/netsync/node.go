...
import (
	...
	"github.com/gordanet/gord/stability-tests/common/mine"
...
func setupSyncee() (*rpc.Client, func(), error) {
	...
	synceeDataDir, err := useDirOrCreateTemp(activeConfig().SynceeDataDirectory, "syncee-gord-data-dir")
	if err != nil {
		return nil, nil, err
	}
...
func setupSyncer() (*rpc.Client, func(), error) {
	...
	syncerDataDir, err := useDirOrCreateTemp(activeConfig().SyncerDataDirectory, "syncer-gord-data-dir")
	if err != nil {
		return nil, nil, err
	}
