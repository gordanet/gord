...
A Block defines a gor block that provides easier and more efficient
...
The Address interface provides an abstraction for a gor address. While the
most common type is a pay-to-pubkey, gor already supports others and
...
To decode/encode an address:
	...
	addrString := "gor:qqj9fg59mptxkr9j0y53j5mwurcmda5mtza9n6v9pm9uj8h0wgk6uma5pvumr"
	defaultPrefix := util.Bech32PrefixGor
